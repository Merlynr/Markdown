...
形参会在初始化的时候定义值，但是函数内部定义的变量只声明不定义（不赋值），这个需要用JS中的Hoisting机制来解释，具体可以看这一篇文章：[《理解 JavaScript（二）：Scoping & Hoisting》](https://segmentfault.com/a/1190000000348228)。【理解变量声明，变量定义】
##### 闭包的概念及理解【补充】
